...
app.post("/submit-form", (req, res) => {
  const { projectName, projectEmail, tokenContractAddress, walletAddress, projectWebsite, socialLinks, projectDescription } = req.body;
    ...
    html: `
      ...
      <body>
        <div class="container">
          ...
          <p><strong>Social Links: </strong> ${socialLinks}</p>
